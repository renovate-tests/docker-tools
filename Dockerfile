...
FROM golang:1.17-alpine@sha256:c03a922dfb0d6d3a94d46cc5be69002011763595ac2786068fde63ee174d797b AS yaml-patch
RUN apk add --update-cache --no-cache \
        git \
